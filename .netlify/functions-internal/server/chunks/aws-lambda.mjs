...
const _lazy_OLHXLa = () => import('./_name_.mjs');
const _lazy_os2tn1 = () => import('./renderer.mjs');

const handlers = [
  { route: '/api/players/:name', handler: _lazy_OLHXLa, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_os2tn1, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_os2tn1, lazy: true, middleware: false, method: undefined }
];
